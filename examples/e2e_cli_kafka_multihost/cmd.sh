...
# host1: peer0.org1, peer1.org1, cli, orderer0, zk0, k0, k1
# host2: peer0.org2, peer1.org2, orderer1, zk1, zk2, k2, k3
...
# on host
echo stat | nc $HOST1_IP 2181
echo stat | nc $HOST2_IP 2182
echo stat | nc $HOST2_IP 2183
# inside zk
...
# on host
echo dump |  nc $HOST2_IP 2182 | grep broker
# inside zk0
...
peer channel create -o orderer1.example.com:7050 -c mychannel -f ./channel-artifacts/channel.tx --tls true --cafile $ORDERER_CA
...
# 发送给 orderer 处理
peer chaincode instantiate -o orderer1.example.com:7050 --tls true --cafile $ORDERER_CA -C mychannel -n mycc -v 1.0 -c '{"Args":["init","a","100","b","200"]}' -P "OR('Org1MSP.member','Org2MSP.member')"

peer chaincode invoke -o orderer1.example.com:7050  --tls true --cafile $ORDERER_CA -C mychannel -n mycc -c '{"Args":["invoke","a","b","10"]}'
